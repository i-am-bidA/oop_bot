Простий бот, що відповідає на питання шкільної програми з географії, філології, математики, фізики, може працювати з текстом та мотивувати. Записує завершені діалоги до файлу txt.
